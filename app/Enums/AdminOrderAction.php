...
enum AdminOrderAction: string
{
    ...
    case ConfirmDelivery = 'confirm_delivery';
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::ConfirmDelivery => 'Confirmar entrega',
    ...
    public function confirmationTitle(): string
    {
        return match ($this) {
            ...
            self::ConfirmDelivery => 'Confirmar entrega al cliente',
    ...
    public function confirmationMessage(): string
    {
        return match ($this) {
            ...
            self::ConfirmDelivery => 'La entrega y el pedido quedaran finalizados.',
    ...
    public function successMessage(): string
    {
        return match ($this) {
            ...
            self::ConfirmDelivery => 'La entrega fue confirmada y el pedido quedo completado.',
    ...
    public function icon(): string
    {
        return match ($this) {
            ...
            self::ConfirmDelivery, self::ConfirmPickup => 'bi-check-circle',
    ...
    public function routeName(): string
    {
        return match ($this) {
            ...
            self::ConfirmDelivery => 'admin.orders.confirm-delivery',
