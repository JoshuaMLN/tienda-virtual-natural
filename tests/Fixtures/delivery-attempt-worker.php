...
[$script, $database, $barrier, $ready, $orderId, $adminId, $operationToken] = $argv;
...
try {
    ...
    $attempt = app(OrderFulfillmentService::class)->recordDeliveryAttempt(
        $order,
        $admin,
        $operationToken,
        DeliveryAttemptResult::Incident,
        DeliveryAttemptAttribution::Customer,
        'Transportista concurrente',
    ...
    fwrite(STDOUT, json_encode([
        ...
        'operation_token' => $attempt->operation_token,
    ], JSON_THROW_ON_ERROR));
